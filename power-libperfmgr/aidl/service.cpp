...
#define LOG_TAG "android.hardware.power-service.gts4lv-libperfmgr"
...
int main() {
    LOG(INFO) << "Samsung Power HAL AIDL Service with Extension is starting.";
    ...
    LOG(INFO) << "Samsung Power HAL AIDL Service with Extension is started.";
    ...
    // should not reach
    LOG(ERROR) << "Samsung Power HAL AIDL Service with Extension just died.";
    return EXIT_FAILURE;
}
